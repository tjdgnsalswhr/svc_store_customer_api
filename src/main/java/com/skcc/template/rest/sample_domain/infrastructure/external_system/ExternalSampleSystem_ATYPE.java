...
@Slf4j
public class ExternalSampleSystem_ATYPE implements IExternalSampleSystem {

    private RestTemplateBuilder restTemplateBuilder;
    private RestTemplate restTemplate;

    public ExternalSampleSystem_ATYPE(){
    ...
    public ResponseEntity<String> doSomeExternalLogic( final SampleDomainCommandApiRequestDTO sampleDomainCommandApiRequestDTO ) {
        log.debug("[ExternalSampleSystem_ATYPE Called] doSomeExternalLogic");

        ResponseEntity<String> result = restTemplate.getForEntity("/api/rest/sample/and", String.class);
